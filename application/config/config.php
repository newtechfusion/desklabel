...
|
*/
$config['encryption_key'] = md5(DOMAIN.'-dance-baby-dance');
...
|
*/
$config['sess_cookie_name']		= DOMAIN.'_session';
$config['sess_expiration']		= 60 * 60 * 24 * 7;
$config['sess_expire_on_close']	= FALSE;
$config['sess_encrypt_cookie']	= TRUE;
$config['sess_use_database']	= defined('SESS_USE_DATABASE') ? SESS_USE_DATABASE : FALSE;
...
$config['csrf_token_name'] = DOMAIN.'_csrf_name';
$config['csrf_cookie_name'] = DOMAIN.'_csrf_cookie';
...
function state_array(){
	return array('al'=>'alabama','ak'=>'alaska','az'=>'arizona','ar'=>'arkansas','ca'=>'california','co'=>'colorado','ct'=>'connecticut',
		...
		'va'=>'virginia','wi'=>'wisconsin','wy'=>'wyoming','pr'=>'puerto rico');
}
define('AJAX','ajax');
